...
export default function ResumeSummaryPage() {
  ...
  useEffect(() => {
    document.title = '25 Resume Summary Examples That Get Interviews (2026) | ResumeBuildz';
    const desc = document.querySelector('meta[name="description"]');
    const copy = '15 resume summary examples by career stage + 10 by industry. Before/after versions, the 4-part formula, common mistakes, and how to use AI without sounding generic.';
    if (desc) desc.setAttribute('content', copy);
    const ogDesc = document.querySelector('meta[property="og:description"]');
    if (ogDesc) ogDesc.setAttribute('content', copy);
    const ogTitle = document.querySelector('meta[property="og:title"]');
    if (ogTitle) ogTitle.setAttribute('content', '25 Resume Summary Examples That Get Interviews (2026) | ResumeBuildz');
  }, []);
